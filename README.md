...
*   **版本演进 (Changelog)**:
    ...
    *   **v3.3.13 (2026-01-03)**:
        - **Thinking 模式稳定性修复**:
            ...
            - **影响范围**: 这些修复确保了在各种模型切换场景下的稳定性，特别是 Claude 与 Gemini 之间的自由切换。
    ...
    *   **v3.3.9 (2026-01-01)**:
        ...
        - **精准限流与 5xx 故障避让**: 深度集成 Google API JSON 报文解析，支持毫秒级 `quotaResetDelay` 提取，并在 500/503/529 故障时自动触发 20s 避让隔离，实现平滑热切换。
...
<div align="center">
  <p>如果您觉得这个工具有所帮助，欢迎在 GitHub 上点一个 </p>
